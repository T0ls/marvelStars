...
function clickLogin() {
	document.getElementById("authModalButton").click();
}
...
function fillCarouselPage(data, pageClone, parent) {
	const elementGen = pageClone.querySelector('#templateApparition');
...
async function getTotalHeroesStartsW() {
	...
	return characterData.data.total;
}
...
function getFromLS(key) {
	...
	if (value !== null) {
		...
		console.warn(`No value found with the provided key: ${key}`);
		return null;
	}
}
